...
"color: rgb(255, 255, 255);")
        ...
        self.actionAlign_Right = QtWidgets.QAction(Editor)
        icon9 = QtGui.QIcon()
    ...
    def retranslateUi(self, Editor):
        ...
        self.actionAlign_Right.setText(_translate("Editor", "Aligh Right"))
        self.actionAlign_Right.setToolTip(_translate("Editor", "Align text to the right"))
        self.actionAlign_Right.setShortcut(_translate("Editor", "Ctrl+R"))
